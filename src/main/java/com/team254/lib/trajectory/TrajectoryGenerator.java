...
public class TrajectoryGenerator {
    //all in in
    private static final double kMaxVelocity = 120.0; //120
    ...
    static final Pose2d autoStartingPose = new Pose2d(Constants.kRobotStartingPose.getTranslation().translateBy(new Translation2d(0.0, 0.0)), Rotation2d.fromDegrees(0.0)); //set initial pose of robot
    //static final Pose2d newAutoStartingPose = new Pose2d(Constants.kNewRobotStartingPose.getTranslation().translateBy(new Translation2d(0.0, 0.0)), Rotation2d.fromDegrees(0.0)); //set initial pose of robot
    ...
    static final Pose2d altAutoStartingPose = new Pose2d(Constants.kAltRobotStartingPose.getTranslation().translateBy(new Translation2d(0.0, 0.0)), Rotation2d.fromDegrees(0.0));
    ...
    public class TrajectorySet {
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getTestPath(){
            ...
            waypoints.add(new Pose2d(new Translation2d(48, -48), Rotation2d.fromDegrees(0)));
            waypoints.add(new Pose2d(new Translation2d(120, -48), Rotation2d.fromDegrees(0)));
            waypoints.add(new Pose2d(new Translation2d(120, 0), Rotation2d.fromDegrees(90)));


            // waypoints.add(new Pose2d(new Translation2d(18*12-halfWidth, 0), Rotation2d.fromDegrees(0)));
            // waypoints.add(new Pose2d(new Translation2d(16*12-halfWidth, 6*12-halfWidth), Rotation2d.fromDegrees(90)));
            // waypoints.add(new Pose2d(new Translation2d(101-halfWidth, 0), Rotation2d.fromDegrees(90)));
            // waypoints.add(new Pose2d(new Translation2d(4*12-halfWidth, 6*12-halfWidth), Rotation2d.fromDegrees(0)));
            // waypoints.add(autoStartingPose);



            //to go negative you need to se the reversed boolean to true
