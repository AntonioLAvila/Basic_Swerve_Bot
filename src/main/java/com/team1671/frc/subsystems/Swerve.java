...
import com.team1671.lib.math.vectors.VectorField;
import com.team1671.lib.util.DriveSignal;
import com.team1671.lib.util.Kinematics;
import com.team1671.lib.util.SwerveHeadingController;
import com.team1671.lib.util.SwerveInverseKinematics;
import com.team1671.lib.util.SynchronousPIDF;
...
public class Swerve extends Subsystem{
	...
	*/
	...
	public synchronized void zeroSensors(Pose2d startingPose){
		...
		//robotState.reset(Timer.getFPGATimestamp(), startingPose, Turret.getInstance().getRotation());
		distanceTraveled = 0;
	}
