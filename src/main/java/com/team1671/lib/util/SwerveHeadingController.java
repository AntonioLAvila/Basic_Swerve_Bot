...
public class SwerveHeadingController {
	...
	public SwerveHeadingController(){
		if(Settings.kIsUsingTractionWheels){
			stabilizationPID = new SynchronousPIDF(0.0088, 0.0, 0.00025, 0.0); //move and turn
			snapPID = new SynchronousPIDF(0.02, 0.0, 0.0, 0.0); //0.02, 0.0, 0.0, 0.0
			stationaryPID = new SynchronousPIDF(0.0088, 0.0, 0.00035, 0.0); //stationary turn
		}else{
